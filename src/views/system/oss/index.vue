...
import { listOss, delOss, getOssPreviewEnabled, updateOssPreviewEnabled } from '@/api/system/oss';
...
import { parseTime } from '@/utils/tmx';
...
const getList = async () => {
  await withLoading(async () => {
    const res = await getOssPreviewEnabled();
    previewListResource.value = res.data;
...
const handlePreviewListResource = async (preview: boolean) => {
  try {
    await updateOssPreviewEnabled(preview);
    await getList();
