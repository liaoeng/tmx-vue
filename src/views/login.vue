  ...
  <div class="login">
    <div class="login-shell">
      <section class="login-brand">
        <span class="brand-pill">tmx Workspace</span>
        <h1 class="brand-title">tmx 模板与扩展</h1>
        <p class="brand-desc">
          真正面向企业级的应用框架 组件化 模块化 轻耦合 高扩展 针对企业痛点 业界一流技术栈
          <br />
          内置通用后台能力 集成 Sa-Token、Mybatis-Plus、WarmFlow、SpringDoc、Hutool、OSS。
        </p>
    ...
    <div class="el-login-footer">
      <span>tmx · 模板与扩展 · {{ currentYear }}</span>
    </div>
  </div>
</template>
