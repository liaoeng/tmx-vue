  ...
  <div class="navbar" :class="'nav' + navType">
    ...
    <div class="right-menu flex align-center">
      <template v-if="appStore.device !== 'mobile'">
        ...
        <el-tooltip v-if="sourceUrl" content="项目源码" effect="dark" placement="bottom">
          <tmx-git id="tmx-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip v-if="docsUrl" :content="$t('navbar.document')" effect="dark" placement="bottom">
          <tmx-doc id="tmx-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
